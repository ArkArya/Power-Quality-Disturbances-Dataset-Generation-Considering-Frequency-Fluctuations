% function xs = c23_swell_with_harmonics_with_oscillatory_transient_freq( )
...
% csvwrite("dataset23_freq.csv",xs);
% csvwrite('dataset23_20db.csv', xs_20);
